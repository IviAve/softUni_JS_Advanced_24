...
// You will be given several towns, with products and their price. You need to find the lowest
//  price for every product and the town it is sold at for that price.
// Input
...
// Output
// As output, you must print each product with its lowest price and the town at which the 
// product is sold at that price. If two towns share the same lowest price,
//  print the one that was entered first. 
