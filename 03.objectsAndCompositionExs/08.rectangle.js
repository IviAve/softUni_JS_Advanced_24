...
//  The rectangle needs to have a width (Number), height (Number),
//   and color (String) properties, which are set via arguments during creation,
...
//  The calcArea() method of the object should return a number. The first letter in
//  the color must be upperCase().
