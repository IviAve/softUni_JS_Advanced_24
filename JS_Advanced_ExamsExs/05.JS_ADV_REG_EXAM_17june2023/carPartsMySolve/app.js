...
function solve() {
        ...
        let partInfoList = document.querySelector('.info-list');
        let partConfirmList = document.querySelector('.confirm-list');
        ...
        function onNext(e) {
                ...
                partInfoList.appendChild(liElementInfo);
                ...
                function onContinue() {
                        ...
                        partConfirmList.appendChild(liElementconfirm);
