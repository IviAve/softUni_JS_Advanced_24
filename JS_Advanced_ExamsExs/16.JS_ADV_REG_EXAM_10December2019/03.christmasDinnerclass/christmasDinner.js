...
// •	Otherwise, you should push the type of the product in the products array, decrease 
// the budget with the price of the product and return a message: 
...
// •	The products require to prepare the meal are in contained the productList. If
//  all the products from the productList are present in the products array you should 
//  push an object in the following format: { recipeName, productList } to the dishes 
//  array and return a message:
...
// •	Otherwise create a new key and value pair to the guest object with key the name 
// of the guest and value - the dish in the format: {{guestName}: {dish}} and return a message: 
// "You have successfully invited {name}!"
// showAttendance()
// This function should return a sting with all the guest, the dish they are having and 
// the products the dish is made of, separated by a comma and space (product, product) in the following format:
