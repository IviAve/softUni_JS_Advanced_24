...
// Write a class that represents a Circle. It has only one data property - its radius, 
// and it is set through the constructor. The class needs to have getter and setter 
// methods for its diameter - the setter needs to calculate the radius and change it 
